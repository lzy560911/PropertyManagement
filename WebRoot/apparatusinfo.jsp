...
<script type="text/javascript">
	...
	function search(){
		...
		var url = "Apparatus!ApparatusSearchByCondition?app_aname="+search_aname+"&app_name="+search_name+"&app_time="+search_time;
		alert("url is :"+url); 
...
<div class="rightinfo">
    ...
    <div class="tools">
    	<ul class="toolbar">
	        <li><a href="jsp/add_apparatusinfo.jsp"><span><img src="<%=path %>/images/t01.png" /></span>添加</a></li>
        	<%
       			 if (exportToExcel == null) {
    		%>
	        <li><a href="apparatusinfo.jsp?exportToExcel=YES"><span><img src="<%=path %>/images/t01.png" /></span>导出本页为Excel</a></li>
        	<% 
       			 }
        	%>
    ...
    <div id="search" style="display:none;">
	    <input type="text" id="search_aname" name="search_aname" placeholder="请输入健身器名称" style="border:1px solid #378888">
    ...
    <table class="tablelist">
        ...
        <tbody>
         <s:iterator value="#session.apparatus" var="a" status="i">
				<tr>
					<td>${i.count }</td>
					<td><s:property value="#a.a_id"/></td>
					<td><s:property value="#a.a_name"/></td>
					<td><s:property value="#a.a_manufacturer"/></td>
					<td><s:property value="#a.a_time"/></td>
					<td><s:property value="#a.a_state"/></td>
					<td>
				        <a class="tablelink"
				       		href="Apparatus!ApparatusFindById?id=${a.a_id }"
				         	onclick="javascript:return confirm('您确认修改当前数据么？');">修改</a>
				        <a class="tablelink"
				         	href="Apparatus!ApparatusDelete?id=${a.a_id}"
         ...
         <tr align="center">
		        <td colspan="7">
					<a href="Apparatus!ApparatusFindAll.action?page=1">首页</a>
					<s:if test="#session.page>1">
						<a href="Apparatus!ApparatusFindAll.action?page=${page-1}">上一页</a>
					</s:if>
					<s:if test="#session.page<#session.size">
						<a href="Apparatus!ApparatusFindAll.action?page=${page+1}">下一页</a>
					</s:if>
					<a href="Apparatus!ApparatusFindAll.action?page=${size}">尾页</a>
				<s:iterator value="#session.fenye" var="m" status="i">
					<a href="Apparatus!ApparatusFindAll.action?page=${i.count}">第${i.count}页</a>
				</s:iterator>
					<a href="Apparatus!FindAll.action" style="margin-left:10px;color:#A0522D;"><b>显示全部信息</b></a>
				</td>
		</tr>
    </table>
