...
<div class="rightinfo">
    ...
    <table class="tablelist">
        ...
        <tbody>
	        <s:iterator value="#session.false" var="c" status="i">
				<tr>
					<td>${i.count }</td>
					<td><s:property value="#c.r_id"/></td>
					<td><s:property value="#c.h_house_number"/></td>
					<td><s:property value="#c.r_name"/></td>
					<td><s:property value="#c.r_phone"/></td>
					<td><s:property value="#c.r_message"/></td>
					<td><s:property value="#c.r_time"/></td>
					<td><s:property value="#c.r_state"/></td>
					<td>
				        <a class="tablelink"
